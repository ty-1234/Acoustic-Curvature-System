...
output_path = os.path.join(base_dir, "csv_data", "preprocessed", "withpos_preprocessed_training_dataset.csv")
...
feature_set["PosX"] = df["PosX"]
feature_set["PosY"] = df["PosY"]
feature_set["PosZ"] = df["PosZ"]
