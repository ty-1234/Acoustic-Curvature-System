...
def process_curvature_data():
    """
    Preprocess the combined dataset to create training features.
    
    Performs feature engineering on FFT data, including statistical features,
    band grouping, and peak detection.
    """
    # === Setup file paths ===
